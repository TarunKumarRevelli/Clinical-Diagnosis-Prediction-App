...
disease_data = {
    ...
    "Osteoarthritis": {
        "description": "A degenerative joint disease causing pain and stiffness in joints.",
        "medicines": ["Acetaminophen", "Ibuprofen", "Naproxen", "Celecoxib", "Duloxetine"],
        "specialists": ["Rheumatologist", "Orthopedic Surgeon", "Physical Therapist"]
    },
    "Atrial Fibrillation": {
        "description": "An irregular and often rapid heart rate that can increase risk of stroke.",
        "medicines": ["Warfarin", "Apixaban", "Amiodarone", "Metoprolol", "Digoxin"],
        "specialists": ["Cardiologist", "Electrophysiologist", "General Physician"]
    },
    "Chronic Bronchitis": {
        "description": "Long-term inflammation of the bronchi in the lungs.",
        "medicines": ["Albuterol", "Ipratropium", "Roflumilast", "Theophylline", "Prednisone"],
        "specialists": ["Pulmonologist", "General Physician", "Respiratory Therapist"]
    },
    "Emphysema": {
        "description": "A lung condition that causes shortness of breath due to damage to air sacs.",
        "medicines": ["Albuterol", "Tiotropium", "Fluticasone", "Salmeterol", "Roflumilast"],
        "specialists": ["Pulmonologist", "General Physician", "Respiratory Therapist"]
    }
}
